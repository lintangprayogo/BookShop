...
<div class="row">
    ...
    <div class="col-md-6">
        <ul class="nav nav-pills card-header-pills">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{route('categories.trash')}}">Trashed</a>
            </li>
        ...
        <table class="table table-bordered table-stripped">
            <thead>
                <tr>
                    <th><b>Name</b></th>
                    <th><b>Slug</b></th>
                    <th style="width: 100px;"><b>Image</b></th>
                ...
                <tr>
                    ...
                    <td>
                        <center>
                            ...
                            <form class="d-inline" action="{{route('categories.delete-permanent',[$category->id])}}" method="POST" onsubmit="return confirm('Delete category permanently?')">
                                @csrf
